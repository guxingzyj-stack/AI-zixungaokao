...
function readExcel(fp) {
  ...
  try {
    ...
    throw new Error('Excel import requires optional package "xlsx". For safer production installs, use CSV/JSON or install xlsx only in a local import environment.');
  }
